...
%nfvPPA : could only find left IFG and left orbital
...
VOIvoxels_Log=nut_mni2voi(s_beam_file_nm4,3,33);
rivets.MNIdb.cNames{3}(33)
VOIvoxels=VOIvoxels_Log;
save VOIvoxels_Log.mat VOIvoxels
clear VOIvoxels;

%svPPA : could only find left superior and middle temporal gyri, which include the pole.  use middle temporal gyrus above (Lmt)
...
%save VOI_Left_lvPPA.mat VOIvoxels
%clear VOIvoxels;
