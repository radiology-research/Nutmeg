function Fsummary=nut_voi_nonwordlat(s_beam_file_nm4,subject_id,wadaresult)
%function Fsummary=nut_voi_nonwordlat(s_beam_file,subject_id,wadaresult)
%
...
nut_mni2languagevoi_nw(s_beam_file_nm4) %Create MNI-based VOIs using rivets.MNIdb
