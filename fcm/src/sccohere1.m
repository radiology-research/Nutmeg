function sccohere1(filtfile,wfile,chfile,n,stp,ftype,lofrq,hifrq,nfft,varargin)
...
if nargin<9
    fprintf('\nusage: sccohere1 filtfile wfile chfile len overlap ftype lofrq hifrq nfft [options]\n\n')
    return
end
